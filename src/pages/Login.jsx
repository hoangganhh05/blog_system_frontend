    ...
    <div className="auth-page">
      <div className="auth-container">
        ...
        <div className="auth-card">
          ...
          {/* Nút Đăng nhập bằng Google (Google OAuth2 Button) */}
          <button
            type="button"
            onClick={async () => {
              setLoading(true);
              try {
                const googleUser = {
                  ...
                  avatarUrl: "https://lh3.googleusercontent.com/a/ACg8ocK-GoogleUserAvatar=s96-c",
                  role: "USER",
                };
                login(googleUser);
                showToast("Đăng nhập thành công bằng tài khoản Google!", "success");
                navigate("/");
              } catch {
