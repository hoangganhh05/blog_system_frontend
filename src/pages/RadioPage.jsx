...
export default function RadioPage() {
  ...
  const handleAddSingleSong = async (e) => {
    ...
    if (!singleSong.title.trim() || !singleSong.src.trim()) {
      toast.error("Vui lòng nhập tên bài hát và link URL âm thanh!");
      return;
    }
    ...
    try {
      ...
      toast.success(`Đã thêm bài hát "${singleSong.title}" vào Database thành công!`);
      setSingleSong({ title: "", artist: "", genre: "V-Pop", cover: "", src: "" });
      setIsImportModalOpen(false);
      window.location.reload();
    } catch {
      toast.error("Không thể thêm bài hát lúc này. Vui lòng kiểm tra lại!");
    } finally {
  ...
  return (
    <div className="w-full min-h-screen py-6 px-3 sm:px-6 max-w-5xl mx-auto flex flex-col gap-6">
      ...
      {/* ======================================================================
          2. PLAYLIST TOOLBAR, SEARCH & IMPORT BUTTON
          ====================================================================== */}
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="text-[11px] text-zinc-500 dark:text-zinc-400">
              {filteredSongs.length} bài hát trong Database (Trang {currentPage + 1}/{totalPages})
            </span>
          </div>
        </div>

        {/* Actions: Search & Add/Import Modal */}
      ...
      {/* ======================================================================
          4. GRID DANH SÁCH BÀI HÁT PHÂN TRANG (12 BÀI/TRANG, HỖ TRỢ 1000+ BÀI)
          ====================================================================== */}
